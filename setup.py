...
setup(
  ...
  version = '0.9.32',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/sdswart/pysts/archive/v_0.9.32.tar.gz',    # Used for pipy
